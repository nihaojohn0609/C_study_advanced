...
WorkspacePath          :=C:/dev/C/Advanced
ProjectPath            :=C:/dev/C/Advanced/Challenge3
...
SharedObjectLinkerName :=C:/cygwin64/bin/gcc.exe -shared -IPIC
ObjectSuffix           :=.o
DependSuffix           :=.o.d
PreprocessSuffix       :=.i
DebugSwitch            :=-g 
...
SourceSwitch           :=-c 
OutputDirectory        :=C:/dev/C/Advanced/build-$(WorkspaceConfiguration)/bin
...
Objects0=$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IntermediateDirectory)/display.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/dev/C/Advanced/Challenge3/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/display.c$(ObjectSuffix): display.c $(IntermediateDirectory)/display.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/dev/C/Advanced/Challenge3/display.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/display.c$(ObjectSuffix) $(IncludePath)
